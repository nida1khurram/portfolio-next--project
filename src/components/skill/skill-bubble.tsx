          ...
          <div className="p-4 w-[100%] md:w-1/3">
            <div className="flex rounded-lg h-full  p-8 flex-col items-center bg-[#000] shadow-2xl shadow-white/50">
              <div className="flex items-center mb-3">
                ...
                <h2 className=" text-lg title-font font-medium">CSS</h2>
              </div>
              <div className="flex-grow">
                <Image
                  src={"/picture/bubble.png"}
          ...
          <div className="p-4 w-[100%] md:w-1/3">
            <div className="flex rounded-lg h-full  p-8 flex-col items-center bg-[#000] shadow-2xl shadow-white/50">
              <div className="flex items-center mb-3">
                ...
                <h2 className=" text-lg title-font font-medium">Javascript</h2>
              </div>
              <div className="flex-grow">
                <Image
                  src={"/picture/bubble.png"}
          ...
          <div className="p-4 w-[100%] md:w-1/3">
            <div className="flex rounded-lg h-full p-8 flex-col items-center bg-[#000] shadow-2xl shadow-white/50">
              <div className="flex items-center mb-3">
                ...
                <h2 className=" text-lg title-font font-medium">Typescript</h2>
              </div>
              <div className="flex-grow">
                <Image
                  src={"/picture/bubble.png"}
          ...
          <div className="p-4 w-[100%] md:w-1/3">
            <div className="flex rounded-lg h-full p-8 flex-col items-center bg-[#000] shadow-2xl shadow-white/50">
              <div className="flex items-center mb-3">
                ...
                <h2 className=" text-lg title-font font-medium">Next.js</h2>
              </div>
              <div className="flex-grow">
                <Image
                  src={"/picture/bubble.png"}
