  ...
  return (
    <>
      ...
      <div className="lg:w-1/2 md:w-2/3 mx-auto px-10 py-10 rounded-lg shadow-2xl shadow-white/50">
          ...
          <form  action="https://formspree.io/f/xpwzpyqo"
                  method="POST">
            ...
            <button
                        className="max-w-[450px] px-10 py-2 rounded-full flex mx-auto text-white
                         bg-gradient-to-r from-[#42d9ce] to-[#303531]   focus:outline-none hover:text-shadow-1  text-2xl font-bold mt-10">Send
              </button>
             ...
             <h2 className="text-2xl text-shadow-1 font-bold mt-8 mx-auto text-center">
                Get in touch</h2>
                <div className="text-2xl mt-10 flex flex-row gap-8  ml-20 md:ml-52">
                 ...
                 <Link target="_blank" href={"https://github.com/nida1khurram"}>
